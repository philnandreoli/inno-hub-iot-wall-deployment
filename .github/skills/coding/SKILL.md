---
name: coding
description: Guidelines for writing, reviewing, and debugging code.
---
...
5. Every time I correct you, add a new rule to the SKILL.md file so it never happens again.
